                ...
                <div class="row">
                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                <figure class="product-main-image">
                                    <img id="product-zoom" src="{{ asset('frontend/img/product-1.jpg') }}"
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            <h1 class="product-title">Yellow button front tea top</h1>
                            <!-- End .product-title -->
                            ...
                            <div class="details-filter-row details-row-size">
                                ...
                                <div class="product-nav product-nav-thumbs">
                                    <a href="#" class="active">
                                        <img src="{{ asset('frontend/img/product-1.jpg') }}" alt="product desc">
                                    </a>
                                    <a href="#">
                                        <img src="{{ asset('frontend/img/product-1.jpg') }}" alt="product desc">
                                    </a>
