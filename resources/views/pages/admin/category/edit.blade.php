                            ...
                            <form action="{{ url('admin/categories/' . $category->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control form-control-sm" id="description" name="description" rows="3">{{ $category->description }}</textarea>
                                        @error('description')
                                            <span class="text-danger" style="font-size: 14px">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset($category->image) }}" alt="" class="mt-2"
                                            width="75">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    id="meta_keyword" value="{{ $category->meta_keyword }}"
                                                    name="meta_keyword">
                                                @error('meta_keyword')
                                                    <span class="text-danger"
                                                        style="font-size: 14px">{{ $message }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control form-control-sm" id="meta_description" name="meta_description"
