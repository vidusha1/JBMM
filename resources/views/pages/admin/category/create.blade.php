                            ...
                            <form action="{{ route('category.create') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control form-control-sm" id="description" placeholder="Category Description"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="meta_title"
                                                    placeholder="Category Meta Title" name="meta_title">
                                                @error('meta_title')
                                                    <span class="text-danger" style="font-size: 14px">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="meta_keyword"
                                                    placeholder="Category Meta Keywords" name="meta_keyword">
                                                @error('meta_keyword')
                                                    <span class="text-danger" style="font-size: 14px">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control form-control-sm" id="meta_description"
                                            placeholder="Category Meta Description" name="meta_description" rows="3"></textarea>
